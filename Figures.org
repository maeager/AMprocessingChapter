...
#+begin_src gnuplot :exports none :file ./gfx/ChComb_MTF.eps  :term postscript eps size 7.00,5.24 enhanced defaultplex  leveldefault color  solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 12
  ...
  set label 12 "Channel Position " at screen -0.05, screen 0.5 center rotate by 90 font "Helvetica,28" front    
    ...
    unset key  
datapath="/media/c4bb64a6-7c5f-4dc1-9965-b0f4c1117b36/Work-archive/cnstellate-03-Feb-2012/TStellate_CT1/ModulationTransferFunction/";
    CSdatapath="/media/c4bb64a6-7c5f-4dc1-9965-b0f4c1117b36/Work-archive/cnstellate-03-Feb-2012/TStellate_CS/ModulationTransferFunction/";
    CTOdatapath="/media/c4bb64a6-7c5f-4dc1-9965-b0f4c1117b36/Work-archive/cnstellate-03-Feb-2012/TStellate_CT1/ModulationTransferFunction/";
    CTTdatapath="/media/c4bb64a6-7c5f-4dc1-9965-b0f4c1117b36/Work-archive/cnstellate-03-Feb-2012/TStellate_CT2/ModulationTransferFunction/";
    ## 'do' command only valid for gnuplot versions 4.5 or above
...
if (ii==1){ splot sprintf("%s%d/vsSPIKES.%d.dat",CTOdatapath,spl,0) matrix using (($1+1)*50):2:3 }
if (ii==2){ splot sprintf("%s%d/vsSPIKES.%d.dat",CTTdatapath,spl,0) matrix using (($1+1)*50):2:3 }
...
*** Gnuplot Rate-area version - datapath="/media/c4bb64a6-7c5f-4dc1-9965-b0f4c1117b36/Work-archive/cnstellate/"

#+name: TStellate_rMTF
#+header:   :term pngcairo enhanced color solid transparent nocrop font 'Verdana,11' linewidth 1.0 dashlength 1.0 size 700,524
#+begin_src gnuplot :exports none :results none
  # :term postscript eps enhanced size 7.00,5.24 defaultplex  leveldefault color  solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 18  
  # :term pdfcairo enhanced color solid font "Helvetica,18" size 700,524
  # :file ./gfx/CS_MTF.eps  
  reset
  ## Keep the figure clean
...
#      } else {
#  splot [50:800][0:99] datapath.spl.'response_area.'.INDEX.'.dat' u 1:2:($4*5)
         splot  datapath.spl.'/response_area.'.ii.'.dat' u 1:2:($4)
...
#+call: TStellate_rMTF[ :file ./gfx/Oct6-12/CS_rMTF.png ](subtype="TStellate_CS") :results none :exports none

#+call: TStellate_rMTF[ :file ./gfx/Oct6-12/CT1_rMTF.png ](subtype="TStellate_CT1") :results none :exports none

#+call: TStellate_rMTF[ :file ./gfx/Oct6-12/CT2_rMTF.png ](subtype="TStellate_CT2") :results none :exports none
