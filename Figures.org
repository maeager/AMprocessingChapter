...
#+BEGIN_SRC gnuplot :export none
  ...
  splot [50:1200] datapath.spl.'/response_area.'.INDEX.'.dat' u 1:($3/1000):($4)
  print "vs "
  unset ylabel
  set cbrange [0:1]
  ...
  if (INDEX >=4){
    splot [50:1200] datapath.spl.'/vsSPIKES.'.INDEX.'.dat' u 1:($3/1000):($5>5.991?$4:NaN) # 5.991 for p<0.05, 13.816 for p<0.01
  } else{
...
#+BEGIN_SRC gnuplot :export none
  ...
  #   if (INDEX< 4){
  INDEX=5
  plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "80" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "60" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "40" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "20" w lp
  #   }else{
  INDEX=4;
  plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "80" w lp, \
       '< awk ''{if($2==50){print $0}}'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "60" w lp, \
       ...
       '< awk ''{if($2==50){print $0}}'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "20" w lp
  #   }
  # datapath.spl.'/response_area.'.INDEX.'.dat' u 1:($3/1000):($4), \
...
#+BEGIN_SRC gnuplot :noweb yes :export none :tangle ./gfx/rtmtfonCF.gpi
  ...
  plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4) not "80" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4) not "60" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4) not "40" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4) not "20" w lp
...
#+BEGIN_SRC gnuplot :export none :tangle ./gfx/mtfonCF.gpi
  ...
  plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4) t "80" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4) t "60" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4) t "40" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4) t "20" w lp
  unset key
  set yrange [0:1]
  set ylabel "Synch Index " font "Helvetica,24"
  ## Block si values where rayleigh test pval less than 0.05 and si greater than 0.98 ()
  plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "80" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "60" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "40" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "20" w lp
...
#+BEGIN_SRC gnuplot :export none
  ...
  # plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "80" w lp, \
  #       '< awk ''{if($2==50){print $0}}'' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "60" w lp, \
  #       '< awk ''{if($2==50){print $0}}'' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "40" w lp, \
  #       '< awk ''{if($2==50){print $0}}'' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "20" w lp
  
  set yrange [0:1]
  set ylabel "Synch Index " font "Helvetica,24"
  
  plot  '< awk ''{if($2==50){print $0}}'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "80" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "60" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "40" w lp, \
        '< awk ''{if($2==50){print $0}}'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "20" w lp
  
  set yrange [0:1]
  set ylabel "SI " font "Helvetica,24"
  
  plot  '< awk ''{if($2==55){print $0}}'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "80" w lp, \
        '< awk ''{if($2==55){print $0}}'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "60" w lp, \
        '< awk ''{if($2==55){print $0}}'' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "40" w lp, \
        '< awk ''{if($2==55){print $0}}'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "20" w lp
  # datapath.spl.'/response_area.'.INDEX.'.dat' u 1:($3/1000):($4), \
...
#+BEGIN_SRC gnuplot :export none
  ...
  set xrange [1:40] #2.805:27.017] #[40:90]
...
#+BEGIN_SRC gnuplot :export none
  ...
  splot  datapath.'/response_area.'.cell.'.dat' u ($3/1000):1:($4)
  }
  cell=0
  ...
  set ylabel "Sound Level (dB SPL)" font "Helvetica,24"
  CT1datapath=sprintf("%s../../TStellate2_CT1/F0Response/",datapath)
  splot  CT1datapath.'/response_area.'.cell.'.dat' u ($3/1000):1:($4)
  unset ylabel; unset cblabel
  CT2datapath=sprintf("%s../../TStellate2_CT2/F0Response/",datapath)
  splot  CT2datapath.'/response_area.'.cell.'.dat' u ($3/1000):1:($4)
  unset multiplot
#+END_SRC
