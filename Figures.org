...
#+BEGIN_SRC gnuplot :export none 
  reset if (INDEX == "" || SPL == "") { unset output; quit}
...
#+name: TStellate_MTF
#+header: :term pdfcairo enhanced color solid font "Helvetica,18" size 7in,5.24in
#+begin_src gnuplot :exports none :results none
  #:term pngcairo size 700,524 enhanced transparent font 'Helvetica,16' #'Verdana,10'
  # :term postscript eps enhanced size 7.00,5.24 defaultplex  leveldefault color  solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 16  
  # :file ./gfx/CS_MTF.eps  
  reset
  ## Keep the figure clean
  load '/media/data/Work/cnstellate/ResponsesNoComp/default.gnu'  
  ...
  ## Apply labels
  set label 1 "A  TS" at screen 0.0833, screen 1.0 center font "Helvetica,22" front
  set label 2 "B  TV" at screen 0.25, screen 1.0 center font "Helvetica,22" front
  set label 3 "C  DS" at screen 0.4166, screen 1.0 center font "Helvetica,22" front
  set label 4 "D GLG" at screen 0.5833, screen 1.0 center font "Helvetica,22" front
  set label 5 "E HSR" at screen 0.75, screen 1.0 center font "Helvetica,22" front
  set label 6 "F LSR" at screen 0.916, screen 1.0 center font "Helvetica,22" front
  set label 7 "20 dB" at screen 1.0, screen 0.875 left font "Helvetica,22" front
  set label 8 "40 dB" at screen 1.0, screen 0.625 left font "Helvetica,22" front
  set label 9 "60 dB" at screen 1.0, screen 0.375 left font "Helvetica,22" front
  set label 10 "80 dB" at screen 1.0, screen 0.125 left font "Helvetica,22" front
...
#        unset ytics; set ytics border out format ""
  ...
  unset multiplot
  #!fixbb 'gfx/Oct-16-12/CS_MTF.eps' 
  # && convert -density 300 './gfx/CS_MTF.eps' './gfx/CS_MTF.png'
  #  !epstopdf 'gfx/Oct-16-12/CS_MTF.eps' 
#+END_SRC


#+call: TStellate_MTF[ :file ./gfx/Oct6-12/CS_MTF.pdf ](subtype="TStellate_CS") :results none :exports none

#+RESULTS: TStellate_MTF[ :file ./gfx/Oct6-12/CS_MTF.pdf ](subtype="TStellate_CS"):results none :exports none
: ./gfx/Oct6-12/CS_MTF.pdf

#+RESULTS: TStellate_MTF[ :file ./gfx/Oct6-12/CS_MTF.png ](subtype="TStellate_CS"):results none :exports none
file:./gfx/Oct6-12/CS_MTF.png

#+RESULTS: TStellate_MTF[ :file ./gfx/Oct6-12/CS_MTF.eps ](subtype="TStellate_CS"):results none :exports none
=./gfx/Oct6-12/CS_MTF.eps
==./gfx/Oct6-12/CS_MTF.eps
==./gfx/Oct6-12/CS_MTF.eps
file:./gfx/Oct6-12/CS_MTF.eps


#+call: TStellate_MTF[ :file ./gfx/Oct6-12/CT1_MTF.png ](subtype="TStellate_CT1") :results none :exports none

#+call: TStellate_MTF[ :file ./gfx/Oct6-12/CT2_MTF.png :results none :exports none](subtype="TStellate_CT2") 
