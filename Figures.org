...
#+BEGIN_SRC gnuplot :noweb yes :export none :tangle ./gfx/rtmtfonCF.gpi
  ...
  plot  '< grep -e ''\s65\s'' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4) not "80" w lp, \
        '< grep -e ''\s65\s'' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4) not "60" w lp, \
        '< grep -e ''\s65\s'' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4) not "40" w lp, \
        '< grep -e ''\s65\s'' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4) not "20" w lp
...
#+BEGIN_SRC gnuplot :export none :tangle ./gfx/mtfonCF.gpi
  ...
  plot  '< grep '' 65 '' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4) t "80" w lp, \
        '< grep '' 65 '' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4) t "60" w lp, \
        '< grep '' 65 '' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4) t "40" w lp, \
        '< grep '' 65 '' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4) t "20" w lp
  unset key
  set yrange [0:1]
  set ylabel "Synch Index " font "Helvetica,24"
