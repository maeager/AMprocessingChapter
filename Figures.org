...
#+BEGIN_SRC gnuplot :export none
  ...
  #   if (INDEX< 4){
  INDEX=5
  plot  '< grep ''\s50\s'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "80" w lp, \
        '< grep ''\s50\s'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "60" w lp, \
        '< grep ''\s50\s'' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "40" w lp, \
        '< grep ''\s50\s'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "20" w lp
  #   }else{
  INDEX=4;
  plot  '< grep ''\s50\s'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "80" w lp, \
       '< grep ''\s50\s'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "60" w lp, \
...
#+BEGIN_SRC gnuplot :noweb yes :export none :tangle ./gfx/rtmtfonCF.gpi
  ...
  plot  '< grep -e ''\s50\s'' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4) not "80" w lp, \
        '< grep -e ''\s50\s'' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4) not "60" w lp, \
        '< grep -e ''\s50\s'' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4) not "40" w lp, \
        '< grep -e ''\s50\s'' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4) not "20" w lp
  
  set yrange [0:1]
  set ylabel "Synch Index " font "Helvetica,24"  
   plot  '< grep -e ''\s50\s'' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "80" w lp, \
         '< grep -e ''\s50\s'' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "60" w lp, \
         '< grep -e ''\s50\s'' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "40" w lp, \
         '< grep -e ''\s50\s'' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($5>5.991?$4:NaN) t "20" w lp
  #   }else{
  INDEX=5;
...
#+BEGIN_SRC gnuplot :export none :tangle ./gfx/mtfonCF.gpi
  ...
  plot  '< grep '' 50 '' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4) t "80" w lp, \
        '< grep '' 50 '' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4) t "60" w lp, \
        '< grep '' 50 '' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4) t "40" w lp, \
        '< grep '' 50 '' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4) t "20" w lp
  unset key
  set yrange [0:1]
  set ylabel "Synch Index " font "Helvetica,24"
  ## Block si values where rayleigh test pval less than 0.05 and si greater than 0.98 ()
  plot  '< grep '' 50 '' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "80" w lp, \
        '< grep '' 50 '' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "60" w lp, \
        '< grep '' 50 '' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "40" w lp, \
        '< grep '' 50 '' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?($4>0.98?NaN:$4):NaN) t "20" w lp
...
#+BEGIN_SRC gnuplot :export none
  ...
  # plot  '< grep '' 50 '' '.datapath.'80/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "80" w lp, \
  #       '< grep '' 50 '' '.datapath.'60/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "60" w lp, \
  #       '< grep '' 50 '' '.datapath.'40/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "40" w lp, \
  #       '< grep '' 50 '' '.datapath.'20/response_area.'.INDEX.'.dat ' u 1:($4/0.05) t "20" w lp
  
  set yrange [0:1]
  set ylabel "Synch Index " font "Helvetica,24"
  
  plot  '< grep '' 50 '' '.datapath.'80/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "80" w lp, \
        '< grep '' 50 '' '.datapath.'60/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "60" w lp, \
        '< grep '' 50 '' '.datapath.'40/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "40" w lp, \
        '< grep '' 50 '' '.datapath.'20/vsSPIKES.'.INDEX.'.dat ' u 1:($7<0.05?$4:NaN) t "20" w lp
