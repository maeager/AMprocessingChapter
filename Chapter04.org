...
band-pass \tMTF responses \cite{RhodeGreenberg:1994}.  Low-pass filters
...
\yellownote{Discuss (Figure \ref{fig:AM:CSMTF}, \ref{fig:AM:CToneMTF} and \ref{fig:AM:CTtwoMTF})}
\AM rate saturation of \TS units on \CF does not disable
