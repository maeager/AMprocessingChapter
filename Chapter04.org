...
homogeneous ANFs split into two SR groups - does this effect outcome in the CNSM model

AM coding important  for vocal communication in \fc less than 3kHz - why use 9 kHz (suited the cat model)

benefit versus detriment of inhibition-excitation in Choppers complicated mixture of input synch phase , synch phase combined with delayed input
inhibition on phase or antiphase   

unsychronised inhibition (like that seen in GLG cells 
