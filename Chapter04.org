...
\chapter[AM and Vowel Coding]{Amplitude Modulation and Vowel Coding in the Stellate Microcircuit}\label{sec:Chapter4}

## NOINCLUDE
#\small{\textbf{Draft Version}: \input{../VowelResponsesChapter/.hg/cache/tags}}
## NOINCLUDE
