...
frequency, is performed using a fast Fourier transform as in Figure \ref{fig:Ch4:def}.
...
#+CAPTION: [Temporal modulation transfer function]{Temporal modulation transfer function. Figure reproduced from \citet{RhodeGreenberg:1994}. Response synchronization (sic) in the figures is analogous to \SI. }
...
Figure \ref{fig:Ch4:ANCNSummary} shows the simplified \fz and temporal \MTF responses
...
characteristics rather than network effects.
  - (Figure \ref{fig:Ch4:ANCNSummary}).
...
\yellownote{TODO refer to Figure \ref{fig:Ch4:RG94MTF}}
...
Figures \ref{fig:Ch4:ChopperONCFMTF}A and B show the \rMTF and \tMTF of the on CF 
\ChS model.
\yellownote{work Fig \ref{fig:Ch4:ChopperONCFMTF} into this section}
