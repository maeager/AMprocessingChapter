...
#+BEGIN_LaTeX
 ...
 z = R^2 / N
  \end{equation}
#+END_LaTeX
/noindent where is $R = N\times\mathsf{SI}$. The p-values were calculated using the
...
excitation and provides little to no information at units with CF's near the f_c
frequency.
