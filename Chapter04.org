...
auditory centres \yellownote{ finish sentence}
...
show snapshots of the possible response characteristics in TS cells. Given the
...
in the \CN stellate microcircuit.  An exploration of the parameter space in the \TS cells of the
...
# set generated in  Chapter \ref{sec:Chapter3}.
# The homogeneity of cell-type responses in the CNSM model limits its realism.
