...
\cite{HinesMorseEtAl:2004}.  Table~\ref{tab:Celltypes2} shows the membrane
...
\cite{GardnerTrussellEtAl:1999}.  Double exponential inhibitory synapses are
...
\cite{FerragamoGoldingEtAl:1998,WickesbergOertel:1993}. TV cells in the deep
...
\cite{PaoliniClareyEtAl:2005,RhodeGreenberg:1994a} and completely inhibit TV
cell responses to loud clicks \cite{SpirouDavisEtAl:1999}. GABAergic inhibition
from Golgi cells modulates the level of excitation necessary to reach threshold
for all CN cells \cite{CasparyBackoffEtAl:1994,FerragamoGoldingEtAl:1998}.
#Feedback circuits from the olivary complex to the ventral CN are also known to
#use GABA as a neurotransmitter \cite{SaintMorestEtAl:1989}, however this is not
...
\cite{KajikawaHackett:2005}. Vector strength and Rayleigh coefficient were also
...
#+name: MTF_atCF_gnu
#+begin_src gnuplot :exports none :file gfx/MTF_atCF.eps :term post eps enh color solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 12
  reset
  load "/media/data/Work/cnstellate/ResponsesNoComp/default.gnu"
...
#+name MTF_example
#+BEGIN_SRC gnuplot :file gfx/MTF_example.eps :term post eps enh color solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 12
...
#+name CS_MTF
#+BEGIN_SRC gnuplot :file gfx/CS_MTF.eps  :term postscript eps enhanced defaultplex  leveldefault color  solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 12
  reset
...
#+name CT1_MTF
#+BEGIN_SRC gnuplot :file gfx/CT1_MTF.eps  :term postscript eps enhanced defaultplex  leveldefault color  solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 12
  reset
  ## Keep the figure clean
    set border 0          # no borders
    unset key
...
#+name CT2_MTF
#+BEGIN_SRC gnuplot :file gfx/CT2_MTF.eps  :term postscript eps enhanced defaultplex  leveldefault color  solid dashlength 1.0 linewidth 2.0 butt noclip palfuncparam 2000,0.003 "Helvetica" 12
  reset
  ## Keep the figure clean
    set border 0          # no borders
    unset key
...
TV cells are thought to be responsible for delayed inhibition or echo-supression
