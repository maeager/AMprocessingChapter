...
Figure \ref{fig:AM:RG94ANF} shows the \MTF response of the \HSR unit on-CF compared with similar experimental data from \citet{RhodeGreenberg:1994}.

#+BEGIN_LaTeX
  \begin{figure}[t!]
    \centering
    \resizebox{0.9\texwidth}{!}{%
